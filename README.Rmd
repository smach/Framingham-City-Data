...
Main directory will include R files for processing data.

data directory includes data both raw and cleaned. When both raw and cleaned data are included, the unedited file names will include `_original`.
